 ...
 *
 * Et surtout : GOOGLE ET APPLE N'ONT PAS DE WIDGET. Ce sont des
 * redirections vers un fournisseur, pas des appels à notre serveur
 * d'authentification. Leur coller un jeton n'apporterait rien et
      ...
      .then(() => {
        ...
        try {
          identifiant.current = api.render(conteneur, {
            ...
            // `auto` suivrait la préférence du système ; cette
            // application est claire quoi qu'en dise le système.
            theme: "light",
    ...
    <div ref={cadre} className={className}>
      ...
      <div role="status" aria-live="polite">
        ...
        {verdict.message !== null && (
          <div
            className={`mb-3 rounded-[var(--radius-control)] px-3.5 py-2.5 text-[var(--text-body)] leading-relaxed ${
              etat === "defi"
